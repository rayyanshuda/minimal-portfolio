  ...
  const projects: { name: string; description: string; href?: string }[] = [
    {
      ...
      href: "https://github.com/rayyanshuda/skin-lesion-class"
    },
    {
      name: "url shortener",
      description:
        "users input a long url (and optionally a custom alias) to generate a short, shareable link.",
      href: "https://github.com/rayyanshuda/url-shortener",
    },
    {
      ...
      href: "https://github.com/rayyanshuda/ai-voice-assistant",
    },
  ];
      ...
      <main className="portfolio">
        ...
        <section className="section" id="work">
          ...
          <ul className="work-list">
            <li>
            <a className="underlined" href="https://cloudact.ca/" target="_blank" rel="noopener noreferrer"> 
            CloudAct CPA 
            </a>
            {" "}
            ...
            <li>
            <a className="underlined" href="https://watai.ca/" target="_blank" rel="noopener noreferrer"> 
            WAT.ai 
            </a>{" "}
              <span className="muted">| machine learning projects</span>
            </li>
            <li>
            <a className="underlined" href="https://github.com/rayyanshuda" target="_blank" rel="noopener noreferrer"> 
            github
            </a>{" "}
              <span className="muted">| miscellaneous coding projects</span>
            </li>
            <li>
            <a className="underlined" href="https://uwaterloo.ca/systems-design-engineering/" target="_blank" rel="noopener noreferrer"> 
